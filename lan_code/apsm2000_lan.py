...
if __name__ == "__main__":
    ...
    # Default IP is 192.168.1.100, but using 192.168.15.100 for local network
    lan_socket = setup_lan_connection(host='192.168.15.100', port=10733)  # Make sure the device is configured to this IP
