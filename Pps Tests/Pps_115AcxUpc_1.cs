...
namespace CalTestGUI
{
    ...
    */
    class Pps_115AcxUpc_1
    {
        ...
        // Required properties initialized through constructor
        ...
        public Pps_115AcxUpc_1(string visaName, string testFreq, string company, string certNum, 
