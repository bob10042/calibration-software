...
namespace CalTestGUI
{
    ...
    */
    public class Pps_3150Afx
    {
        ...
        private double GetCellValue(Excel.Range cell)
        {
            if (cell?.Value != null)
            {
                // Handle different types of values that might come from Excel
                if (cell.Value is double d) return d;
                if (cell.Value is int i) return i;
                if (cell.Value is decimal dec) return (double)dec;
                if (cell.Value is string s && double.TryParse(s, out double result)) return result;
        ...
        public void RunTest()
        {
            ...
            cellvalue = Convert.ToDouble((ThreePh.Cells[77, 2] as Excel.Range).Value);
            ...
            cellvalue = Convert.ToDouble((ThreePh.Cells[80, 2] as Excel.Range).Value);
            Write_PPS(":VOLT:AC," + cellvalue);                     
            Thread.Sleep(15000);            
            PpsLoopOneAcTest();
            ...
            cellvalue = GetCellValue(ThreePh.Cells[83, 2] as Excel.Range);
            Write_PPS(":VOLT:AC," + cellvalue);
            Thread.Sleep(15000);            
            PpsLoopOneAcTest();
            ...
            cellvalue = GetCellValue(ThreePh.Cells[86, 2] as Excel.Range);
            Write_PPS(":VOLT:AC," + cellvalue);
            Thread.Sleep(15000);            
            PpsLoopOneAcTest();
            ...
            cellvalue = GetCellValue(ThreePh.Cells[89, 2] as Excel.Range);
            Write_PPS(":VOLT:AC," + cellvalue);
            Thread.Sleep(15000);            
            PpsLoopOneAcTest();
            ...
            cellvalue = GetCellValue(ThreePh.Cells[92, 2] as Excel.Range);
            Write_PPS(":VOLT:AC," + cellvalue);
            Thread.Sleep(15000);           
            PpsLoopOneAcTest();
            ...
            cellvalue = GetCellValue(ThreePh.Cells[95, 2] as Excel.Range);
            Write_PPS(":VOLT:AC," + cellvalue);
            Thread.Sleep(15000);            
            PpsLoopOneAcTest();
